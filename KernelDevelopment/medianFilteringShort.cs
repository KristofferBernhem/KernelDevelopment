...
namespace KernelDevelopment
{
    class medianFilteringShort
    {
        ...
        public static void Execute()
        {
            ...
            float[] meanVector    = generateTest(depth);      // frame mean value.
            int[] test_data     = generateTest(N, depth);   // pixel values organized as: x1y1z1, x1y1z2,...,x1y1zn, x2y1z1,...                                                               
            // Profiling:
         ...
         * 
         */
        public static void medianKernel(GThread thread, short windowWidth, int[] filterWindow, int depth, int[] inputVector, float[] meanVector, int[] answer)
        {
          ...
          //          answer[answerIndex] = inputVector[answerIndex] - meanVector[zSlice] * filterWindow[index + (windowWidth - 1) / 2]; // InputVector - meanvalueFrame*median.
            ...
            //        answer[answerIndex] = inputVector[answerIndex] - meanVector[zSlice] * (filterWindow[index + (windowWidth) / 2] + filterWindow[index + ((windowWidth) / 2) - 1]) / 2; // InputVector - meanvalueFrame*median.
                    answer[answerIndex] = (ushort)Math.Ceiling((filterWindow[index + (windowWidth-1) / 2] + filterWindow[index + ((windowWidth-1) / 2) + 1]) / 2.0); // InputVector - meanvalueFrame*median. (int) 2+3/2.0 = 2 not 3.                  
                    isOdd = true;
                }
   ...
   //                     answer[answerIndex] = inputVector[answerIndex] - meanVector[zSlice] * filterWindow[index ]; // InputVector - meanvalueFrame*median.
     ...
     //                   answer[answerIndex] = inputVector[answerIndex] - meanVector[zSlice] * (filterWindow[index ] + filterWindow[index - 1]) / 2; // InputVector - meanvalueFrame*median.
                        answer[answerIndex] = (ushort)Math.Ceiling((filterWindow[index] + filterWindow[index - 1]) / 2.0); // InputVector - meanvalueFrame*median. (int) 2+3/2.0 = 2 not 3.
  ...
  //                      answer[answerIndex] = inputVector[answerIndex] - meanVector[zSlice] * filterWindow[index]; // InputVector - meanvalueFrame*median.
                    ...
                    {
 //                       answer[answerIndex] = inputVector[answerIndex] - meanVector[zSlice] * (filterWindow[index] + filterWindow[index - 1]) / 2; // InputVector - meanvalueFrame*median.
                        answer[answerIndex] = (ushort)Math.Ceiling((filterWindow[index] + filterWindow[index + 1]) / 2.0); // InputVector - meanvalueFrame*median.
                        isOdd               = true;
                        index++;
                    }
                    // Update counters:
